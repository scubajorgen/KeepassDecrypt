...
public class Salsa20
{
    ...
    private final static byte[] tau     = "expand 16-byte k".getBytes();
     ...
     */
    private int             index       = 0;
    private final int[]     engineState = new int[stateSize]; // state
    private final int[]     x           = new int[stateSize] ; // internal buffer
    private final byte[]    keyStream   = new byte[stateSize * 4]; // expanded state, 64 bytes
